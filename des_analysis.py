...
def main(argv):
	...
	if not coadd_:
		...
		folder=[f+'/g1002/ngmix/coadd_oversample_psf_final/',f+'/g1n002/ngmix/coadd_oversample_psf_final/', f+'/g2002/ngmix/coadd_oversample_psf_final/',f+'/g2n002/ngmix/coadd_oversample_psf_final/']
