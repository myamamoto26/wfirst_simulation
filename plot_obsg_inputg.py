...
def main(argv):
	...
	if sys.argv[1]=='metacal':
		...
		mc_offsets=[10,20,35,45,60]
		error_g1_neg=[np.std(del_g1_neg2_mc10)/np.sqrt(len(del_g1_neg2_mc10)), np.std(del_g1_neg2_mc20)/np.sqrt(len(del_g1_neg2_mc20)), np.std(del_g1_neg2_mc35)/np.sqrt(len(del_g1_neg2_mc35)), np.std(del_g1_neg2_mc45)/np.sqrt(len(del_g1_neg2_mc45)), np.std(del_g1_neg2_mc60)/np.sqrt(len(del_g1_neg2_mc60))]
		mean_difference_g1_neg = [np.mean(del_g1_neg2_mc10), np.mean(del_g1_neg2_mc20), np.mean(del_g1_neg2_mc35), np.mean(del_g1_neg2_mc45), np.mean(del_g1_neg2_mc60)]
		error_g1_pos=[np.std(del_g1_pos2_mc10)/np.sqrt(len(del_g1_pos2_mc10)), np.std(del_g1_pos2_mc20)/np.sqrt(len(del_g1_pos2_mc20)), np.std(del_g1_pos2_mc35)/np.sqrt(len(del_g1_pos2_mc35)), np.std(del_g1_pos2_mc45)/np.sqrt(len(del_g1_pos2_mc45)), np.std(del_g1_pos2_mc60)/np.sqrt(len(del_g1_pos2_mc60))]
		mean_difference_g1_pos = [np.mean(del_g1_pos2_mc10), np.mean(del_g1_pos2_mc20), np.mean(del_g1_pos2_mc35), np.mean(del_g1_pos2_mc45), np.mean(del_g1_pos2_mc60)]
