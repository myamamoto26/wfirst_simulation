...
def check_multiband_objects():
    ...
    for j,pix in enumerate(medsn):
        H = meds.MEDS('/hpc/group/cosmology/phy-lsst/my137/roman_H158/g1002/meds/fiducial_H158_'+str(pix)+'.fits')
        F = meds.MEDS('/hpc/group/cosmology/phy-lsst/my137/roman_H158/g1002/meds/fiducial_F184_'+str(pix)+'.fits')
        J = meds.MEDS('/hpc/group/cosmology/phy-lsst/my137/roman_H158/g1002/meds/fiducial_J129_'+str(pix)+'.fits')
